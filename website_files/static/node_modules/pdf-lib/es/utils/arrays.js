...
export var typedArrayFor = function typedArrayFor(value) {
...
export var mergeIntoTypedArray = function mergeIntoTypedArray() {
    var arrays = [];
...
export var mergeUint8Arrays = function mergeUint8Arrays(arrays) {
    var totalSize = 0;
...
export var arrayAsString = function arrayAsString(array) {
    var str = '';
...
export var byAscendingId = function byAscendingId(a, b) {
    return a.id - b.id;
};
export var sortedUniq = function sortedUniq(array, indexer) {
    var uniq = [];
...
export var reverseArray = function reverseArray(array) {
...
export var sum = function sum(array) {
    var total = 0;
...
export var pluckIndices = function pluckIndices(arr, indices) {
...
export var canBeConvertedToUint8Array = function canBeConvertedToUint8Array(input) {
