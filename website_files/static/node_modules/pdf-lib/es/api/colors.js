...
export var grayscale = function grayscale(gray) {
...
export var rgb = function rgb(red, green, blue) {
...
export var cmyk = function cmyk(cyan, magenta, yellow, key) {
...
export var setFillingColor = function setFillingColor(color) {
...
export var setStrokingColor = function setStrokingColor(color) {
...
export var componentsToColor = function componentsToColor(comps, scale) {
    if (scale === void 0) {
        scale = 1;
    }
...
export var colorToComponents = function colorToComponents(color) {
