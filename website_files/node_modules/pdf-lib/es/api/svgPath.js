...
var apply = function apply(commands) {
...
var solveArc = function solveArc(x, y, coords) {
    var rx = coords[0],
        ry = coords[1],
        rot = coords[2],
        large = coords[3],
...
var segmentToBezier = function segmentToBezier(cx1, cy1, th0, th1, rx, ry, sinTh, cosTh) {
    var a00 = cosTh * rx;
    var a01 = -sinTh * ry;
    var a10 = sinTh * rx;
    var a11 = cosTh * ry;
...
export var svgPathToOperators = function svgPathToOperators(path) {
