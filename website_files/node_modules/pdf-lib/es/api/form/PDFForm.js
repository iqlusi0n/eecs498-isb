...
var convertToPDFField = function convertToPDFField(field, ref, doc) {
...
var splitFieldName = function splitFieldName(fullyQualifiedName) {
...
var addFieldToParent = function addFieldToParent(_a, _b, partialName) {
    var parent = _a[0],
        parentRef = _a[1];
    var field = _b[0],
        fieldRef = _b[1];
