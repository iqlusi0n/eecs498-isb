...
export var backtick = function backtick(val) {
    return "`" + val + "`";
};
export var singleQuote = function singleQuote(val) {
    return "'" + val + "'";
}; // prettier-ignore
...
export var createValueErrorMsg = function createValueErrorMsg(value, valueName, values) {
...
export var assertIsOneOf = function assertIsOneOf(value, valueName, allowedValues) {
...
export var assertIsOneOfOrUndefined = function assertIsOneOfOrUndefined(value, valueName, allowedValues) {
    if (!Array.isArray(allowedValues)) {
        allowedValues = objectValues(allowedValues);
    }
...
export var assertIsSubset = function assertIsSubset(values, valueName, allowedValues) {
    if (!Array.isArray(allowedValues)) {
        allowedValues = objectValues(allowedValues);
    }
...
export var getType = function getType(val) {
...
export var createTypeErrorMsg = function createTypeErrorMsg(value, valueName, types) {
...
export var assertIs = function assertIs(value, valueName, types) {
    for (var idx = 0, len = types.length; idx < len; idx++) {
...
export var assertOrUndefined = function assertOrUndefined(value, valueName, types) {
    assertIs(value, valueName, types.concat('undefined'));
};
export var assertEachIs = function assertEachIs(values, valueName, types) {
    for (var idx = 0, len = values.length; idx < len; idx++) {
        assertIs(values[idx], valueName, types);
    }
};
export var assertRange = function assertRange(value, valueName, min, max) {
...
export var assertRangeOrUndefined = function assertRangeOrUndefined(value, valueName, min, max) {
    assertIs(value, valueName, ['number', 'undefined']);
    if (typeof value === 'number') assertRange(value, valueName, min, max);
};
export var assertMultiple = function assertMultiple(value, valueName, multiplier) {
    assertIs(value, valueName, ['number']);
