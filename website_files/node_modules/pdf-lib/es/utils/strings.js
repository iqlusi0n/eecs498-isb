export var toCharCode = function toCharCode(character) {
    return character.charCodeAt(0);
};
export var toCodePoint = function toCodePoint(character) {
    return character.codePointAt(0);
};
export var toHexStringOfMinLength = function toHexStringOfMinLength(num, minLength) {
    return padStart(num.toString(16), minLength, '0').toUpperCase();
};
export var toHexString = function toHexString(num) {
    return toHexStringOfMinLength(num, 2);
};
export var charFromCode = function charFromCode(code) {
    return String.fromCharCode(code);
};
export var charFromHexCode = function charFromHexCode(hex) {
    return charFromCode(parseInt(hex, 16));
};
export var padStart = function padStart(value, length, padChar) {
    var padding = '';
...
export var copyStringIntoBuffer = function copyStringIntoBuffer(str, buffer, offset) {
...
export var addRandomSuffix = function addRandomSuffix(prefix, suffixLength) {
...
export var cleanText = function cleanText(text) {
    return text.replace(/\t|\u0085|\u2028|\u2029/g, '    ').replace(/[\b\v]/g, '');
};
export var escapedNewlineChars = ['\\n', '\\f', '\\r', "\\u000B"];
export var newlineChars = ['\n', '\f', '\r', "\x0B"];
export var isNewlineChar = function isNewlineChar(text) {
    return /^[\n\f\r\u000B]$/.test(text);
};
export var lineSplit = function lineSplit(text) {
    return text.split(/[\n\f\r\u000B]/);
};
export var mergeLines = function mergeLines(text) {
    return text.replace(/[\n\f\r\u000B]/g, ' ');
...
export var charAtIndex = function charAtIndex(text, index) {
...
export var charSplit = function charSplit(text) {
    var chars = [];
...
var buildWordBreakRegex = function buildWordBreakRegex(wordBreaks) {
...
export var breakTextIntoLines = function breakTextIntoLines(text, wordBreaks, maxWidth, computeWidthOfText) {
    ...
    var pushCurrLine = function pushCurrLine() {
...
export var parseDate = function parseDate(dateStr) {
