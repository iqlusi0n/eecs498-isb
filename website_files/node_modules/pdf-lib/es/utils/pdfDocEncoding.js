import {
    toCharCode
} from "./strings"; // Mapping from PDFDocEncoding to Unicode code point
...
pdfDocEncodingToUnicode[0x16] = toCharCode("\x17"); // SYNCRONOUS IDLE
...
export var pdfDocEncodingDecode = function pdfDocEncodingDecode(bytes) {
