...
export var encodeToBase64 = function encodeToBase64(bytes) {
    var base64 = '';
...
export var decodeFromBase64 = function decodeFromBase64(base64) {
...
export var decodeFromBase64DataUri = function decodeFromBase64DataUri(dataUri) {
    var trimmedUri = dataUri.trim();
    var prefix = trimmedUri.substring(0, 100);
    var res = prefix.match(DATA_URI_PREFIX_REGEX); // Assume it's not a data URI - just a plain base64 string

    if (!res) return decodeFromBase64(trimmedUri); // Remove the data URI prefix and parse the remainder as a base64 string
